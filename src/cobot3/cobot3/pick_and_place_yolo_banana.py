#!/usr/bin/env python3
"""
YOLO 연동 바나나 Pick and Place
================================
환경 : Ubuntu 22.04, ROS2 Humble, Isaac Sim 5.1.0
실행 : ros2 run cobot3 pick_and_place_yolo_banana

동작:
  /detected_object/xyz_robot 구독 (panda_link0 기준)
  X, Y : YOLO 탐지 결과 사용
  Z    : 바나나 실제 높이 고정값 사용 (PICK_Z)

실행 순서:
  1. Isaac Sim Play
  2. ros2 launch panda_moveit_config demo.launch.py
  3. ros2 launch cobot3 camera_static_tf.launch.py
  4. ros2 run cobot3 yolo11_node
  5. ros2 run cobot3 depth_to_3d
  6. ros2 run cobot3 tf_transformer
  7. ros2 run cobot3 pick_and_place_yolo_banana
"""
