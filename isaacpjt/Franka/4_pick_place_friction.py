...
# 4~6번 구간(집기→이동)을 느리게 조정
EVENTS_DT = [0.008, 0.005, 0.1, 0.1, 0.008, 0.008, 0.008, 1, 0.008, 0.08]
...
class FrankaTask(BaseTask):
    ...
    def set_up_scene(self, scene):
        ...
        self._register_robot(scene)  # 2. REGISTER
        self._setup_physics()        # 3. PHYSICS  (Franka prim 생성 후)
        self._create_scene(scene)    # 4. SCENE
        print("\n  [완료] 씬 구성 성공!\n")
